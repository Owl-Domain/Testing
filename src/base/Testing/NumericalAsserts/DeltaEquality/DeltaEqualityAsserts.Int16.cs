...
public static partial class AssertExtensions
{
   ...
   /// <inheritdoc cref="AreEqual(IAssert, short, short, short, string, string, string, int)"/>
   public static IAssert AreEqual(
      this IAssert assert,
      [DisallowNull] short? value,
      short expected,
      short delta,
      [CallerArgumentExpression(nameof(value))] string valueArgument = "<value>",
      [CallerArgumentExpression(nameof(expected))] string expectedArgument = "<expected>",
   ...
   /// <inheritdoc cref="AreNotEqual(IAssert, short, short, short, string, string, string, int)"/>
   public static IAssert AreNotEqual(
      this IAssert assert,
      [DisallowNull] short? value,
      short expected,
