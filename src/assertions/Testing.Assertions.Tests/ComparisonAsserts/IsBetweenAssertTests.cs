...
public class IsBetweenAssertTests
{
   ...
   [DataRow(10, 0, 10, DisplayName = "Same as maximum")]
   [TestMethod]
   public void IsBetween_MinimumNullable_WithValueInRange_DoesNothing(int value, [DisallowNull] int? minimum, int maximum)
   {
      // Act
      IAssert result = AssertExtensions.IsBetween(_assert.Object, value, minimum, maximum);
   ...
   [DataRow(11, 0, 10, DisplayName = "Above maximum")]
   [TestMethod]
   public void IsBetween_MinimumNullable_WithValueOutsideRange_CallsFail(int value, [DisallowNull] int? minimum, int maximum)
   {
      // Act
      IAssert result = AssertExtensions.IsBetween(_assert.Object, value, minimum, maximum);
   ...
   [DataRow(10, 0, 10, DisplayName = "Same as maximum")]
   [TestMethod]
   public void IsBetween_MaximumNullable_WithValueInRange_DoesNothing(int value, int minimum, [DisallowNull] int? maximum)
   {
      // Act
      IAssert result = AssertExtensions.IsBetween(_assert.Object, value, minimum, maximum);
   ...
   [DataRow(11, 0, 10, DisplayName = "Above maximum")]
   [TestMethod]
   public void IsBetween_MaximumNullable_WithValueOutsideRange_CallsFail(int value, int minimum, [DisallowNull] int? maximum)
   {
      // Act
      IAssert result = AssertExtensions.IsBetween(_assert.Object, value, minimum, maximum);
   ...
   [DataRow(10, 0, 10, DisplayName = "Same as maximum")]
   [TestMethod]
   public void IsNotBetween_MinimumNullable_WithValueInRange_CallsFail(int value, [DisallowNull] int? minimum, int maximum)
   {
      // Act
      IAssert result = AssertExtensions.IsNotBetween(_assert.Object, value, minimum, maximum);
   ...
   [DataRow(11, 0, 10, DisplayName = "Above maximum")]
   [TestMethod]
   public void IsNotBetween_MinimumNullable_WithValueOutsideRange_DoesNothing(int value, [DisallowNull] int? minimum, int maximum)
   {
      // Act
      IAssert result = AssertExtensions.IsNotBetween(_assert.Object, value, minimum, maximum);
   ...
   [DataRow(10, 0, 10, DisplayName = "Same as maximum")]
   [TestMethod]
   public void IsNotBetween_MaximumNullable_WithValueInRange_CallsFail(int value, int minimum, [DisallowNull] int? maximum)
   {
      // Act
      IAssert result = AssertExtensions.IsNotBetween(_assert.Object, value, minimum, maximum);
   ...
   [DataRow(11, 0, 10, DisplayName = "Above maximum")]
   [TestMethod]
   public void IsNotBetween_MaximumNullable_WithValueOutsideRange_DoesNothing(int value, int minimum, [DisallowNull] int? maximum)
   {
      // Act
      IAssert result = AssertExtensions.IsNotBetween(_assert.Object, value, minimum, maximum);
