...
public static partial class AssertExtensions
{
   ...
   {
      ulong actualDelta = Math.Max(value, expected) - Math.Min(value, expected);
   ...
   /// <inheritdoc cref="AreEqual(IAssert, ulong, ulong, ulong, string, string, string, int)"/>
   public static IAssert AreEqual(
      this IAssert assert,
      [DisallowNull] ulong? value,
      ulong expected,
      ulong delta,
      [CallerArgumentExpression(nameof(value))] string valueArgument = "<value>",
      [CallerArgumentExpression(nameof(expected))] string expectedArgument = "<expected>",
      ...
      [CallerLineNumber] int line = 0)
   {
      ulong actualDelta = Math.Max(value.Value, expected) - Math.Min(value.Value, expected);
      bool equality = actualDelta <= delta;
   ...
   public static IAssert AreEqual(
      ...
      [CallerLineNumber] int line = 0)
   {
      ulong actualDelta = Math.Max(value, expected.Value) - Math.Min(value, expected.Value);
      bool equality = actualDelta <= delta;
   ...
   public static IAssert AreEqual(
      ...
      [CallerLineNumber] int line = 0)
   {
      ulong actualDelta = Math.Max(value.Value, expected.Value) - Math.Min(value.Value, expected.Value);
      bool equality = actualDelta <= delta;
   ...
   /// <inheritdoc cref="AreNotEqual(IAssert, ulong, ulong, ulong, string, string, string, int)"/>
   public static IAssert AreNotEqual(
      this IAssert assert,
      [DisallowNull] ulong? value,
      ulong expected,
